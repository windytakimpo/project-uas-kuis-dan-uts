...
.biodata {
  ...
  <body>
        <h1 class="text-center text-success mt-3">Biodata WINDI TAKIMPO</h1>
<div class="container">
  <div class="card kartu">
    <div class="row">
      <div class="col-md-4">
      <div class="foto">
        <img src="foto/foto.jpeg" class="img-thumbnail" alt="" width="150" height="auto">
      </div>
      </div>
        ...
        <table border="0" width="100%" style="padding-left: 2px; padding-right: 13px;">
          <tbody>
            <tr>
              <td width="25%" valign="top" class="textt">Nama</td>
                <td width="2%">:</td>
                <td style="color: #e9a7f9; font-weight:bold">WINDY TAKIMPO</td>
            </tr>
          <tr>
          ...
          <tr>
              <td class="textt">Tempat Lahir</td>
                <td>:</td>
                <td>desa ilath,kota ambon,provinsi maluku</td>
            </tr>
          <tr>
